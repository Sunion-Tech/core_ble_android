...
class LockCredentialUseCase @Inject constructor(
    ...
    suspend fun addCredentialFingerPrint(index: Int, userIndex:Int, credential97Index: Int): Boolean = addCredential(userIndex, BleV3Lock.CredentialDetail(index, type = BleV3Lock.CredentialType.FINGERPRINT.value, code = credential97Index.toLittleEndianByteArrayInt16()))
    suspend fun addCredentialFace(index: Int, userIndex:Int, credential97Index: Int): Boolean = addCredential(userIndex, BleV3Lock.CredentialDetail(index, type = BleV3Lock.CredentialType.FACE.value, code = credential97Index.toLittleEndianByteArrayInt16()))
    ...
    suspend fun editCredentialFingerPrint(index: Int, userIndex:Int, credential97Index: Int): Boolean = editCredential(userIndex, BleV3Lock.CredentialDetail(index, type = BleV3Lock.CredentialType.FINGERPRINT.value, code = credential97Index.toLittleEndianByteArrayInt16()))
    suspend fun editCredentialFace(index: Int, userIndex:Int, credential97Index: Int): Boolean = editCredential(userIndex, BleV3Lock.CredentialDetail(index, type = BleV3Lock.CredentialType.FACE.value, code = credential97Index.toLittleEndianByteArrayInt16()))
