...
class BleDeviceFeature{
    companion object {
        ...
        val taskList: Array<Triple<TaskCode, String, Set<String>>> = arrayOf(
            ...
            Triple(TaskCode.GetAdminCodePosition, "Get admin code position", setOf("3")),
            ...
            Triple(TaskCode.GetUserAbility, "Get user ability", setOf("3")),
            Triple(TaskCode.GetUserCount, "Get user count", setOf("3")),
            ...
            Triple(TaskCode.GetCredential, "Get credential", setOf("3")),
            ...
            Triple(TaskCode.GetAccessCode, "Get access code", setOf("1","2")),
            ...
            Triple(TaskCode.GetAccessCard, "Get access card", setOf("2")),
            ...
            Triple(TaskCode.GetFingerprint, "Get fingerprint", setOf("2")),
            ...
            Triple(TaskCode.GetFace, "Get face", setOf("2")),
            ...
            Triple(TaskCode.GetUserCredentialHash, "Get user credential hash", setOf("3")),
            Triple(TaskCode.GetBleUserHash, "Get ble user hash", setOf("3")),
            ...
            Triple(TaskCode.GetFwModel, "Get firmware model", setOf("1","2","3")),
