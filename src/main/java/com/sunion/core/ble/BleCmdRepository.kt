        ...
        return decrypt(key, notification)?.let { decrypted ->
            ...
            if (checkFunction == function) {
                when (function) {
                    ...
                    0x84, 0x87, 0x8D, 0X8E, 0x9D, 0xA1, 0xC7, 0xC8, 0xCB, 0xCE, 0xCF, 0xD1, 0xD3, 0xD5, 0xD9, 0xE2, 0xE8, 0xEC, 0xED, 0xEE, 0xEF, 0xF4, 0xF6 -> {
                        // Boolean
                        when (booleanData) {
                            0x01 -> true
                            0x00 -> false
                    ...
                    0x8A, 0xC0, 0xC1, 0xD8, 0xE4, 0xEA, 0xF0, 0xF2, 0xF5 -> {
                        // ByteArray
                        byteArrayData
                    }
                    0x8B -> {
